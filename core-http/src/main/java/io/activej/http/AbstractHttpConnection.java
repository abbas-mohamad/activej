...
public abstract class AbstractHttpConnection {
	...
	protected static final AsyncTimeoutException WRITE_TIMEOUT_ERROR = new AsyncTimeoutException(AbstractHttpConnection.class, "Write timeout");
	protected static final ParseException HEADER_NAME_ABSENT = new ParseException(AbstractHttpConnection.class, "Header name is absent");
	protected static final ParseException TOO_LONG_HEADER = new ParseException(AbstractHttpConnection.class, "Header line exceeds max header size");
	protected static final ParseException TOO_MANY_HEADERS = new ParseException(AbstractHttpConnection.class, "Too many headers");
	protected static final ParseException INCOMPLETE_MESSAGE = new TruncatedDataException(AbstractHttpConnection.class, "Incomplete HTTP message");
	protected static final ParseException UNEXPECTED_READ = new UnexpectedDataException(AbstractHttpConnection.class, "Unexpected read data");
	protected static final ParseException INVALID_CRLF = new ParseException(AbstractHttpConnection.class, "Invalid CRLF");
